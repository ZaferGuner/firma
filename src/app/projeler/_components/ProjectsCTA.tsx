...
export function ProjectsCTA({ initialData }: { initialData?: any }) {
  const data = useEditableContent("projects.cta", initialData || projectsPageDefaults.cta);

  return (
    <EditableSection sectionKey="projects.cta" label="Projeler CTA">
    <section className="px-6 md:px-12 py-16 md:py-24 bg-[#f4f2ed] border-t border-[rgba(0,0,0,0.12)]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto shrink-0">
          <Link
            href={data.primaryButtonLink || "/iletisim"}
          ...
          <a
            href={data.secondaryButtonLink || "tel:+905330618001"}
