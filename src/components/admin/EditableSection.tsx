...
export function EditableSection({ sectionKey, label, children }: EditableSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-4 top-4 z-[90] opacity-0 group-hover/editable:opacity-100 transition-opacity duration-200 pointer-events-none">
        <button
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
      ...
      {/* FLOAT AREA LABEL */}
      <div className="absolute left-4 top-4 z-[90] opacity-0 group-hover/editable:opacity-100 transition-opacity duration-200 pointer-events-none">
