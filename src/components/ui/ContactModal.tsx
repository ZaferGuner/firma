        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className={
                opensFromBottom
                  ? "pointer-events-auto absolute bottom-[118px] left-[14px] right-[14px] mx-auto flex max-w-[460px] transform-gpu flex-col overflow-y-auto overscroll-contain bg-site-dark/95 p-6 shadow-[0_24px_64px_rgba(0,0,0,0.5)] backdrop-blur-xl sm:bottom-[132px] sm:p-8"
                  : "pointer-events-auto absolute left-[14px] right-[14px] top-[72px] flex transform-gpu flex-col overflow-y-auto overscroll-contain bg-site-dark/95 p-6 shadow-[0_24px_64px_rgba(0,0,0,0.5)] backdrop-blur-xl sm:p-8 md:left-auto md:right-[24px] md:top-[76px] md:w-[clamp(340px,32vw,460px)]"
              }
              style={{
